...
class QuestionModuleTests(TestCase):
    ...
    def test_was_published_recently_with_old_question(self):
        """
        was_published_recently() returns False question whose pub_date is older than 1 day.
        """
    ...
    def test_was_published_recently_with_recent_question(self):
        ...
        """
        time = timezone.now() - datetime.timedelta(hours=23, minutes=59, seconde=59)
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        """
        The detail view of a questio nwith a pub_date in the future returns a 404 not found
        """
